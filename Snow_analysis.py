...
def create_enhanced_dashboard(df, output_dir):
    ...
    plt.tight_layout()
    output_file = os.path.join(output_dir, 'Winter_Analysis_Dashboard_Final.png')
...
def export_detailed_csv(df, output_dir):
    ...
    export_file = os.path.join(output_dir, 'Winter_Data_Full_Labeled.csv')
    ...
    export_file = os.path.join(output_dir, 'Winter_Monthly_Summary_Labeled.csv')
    ...
    export_file = os.path.join(output_dir, 'Winter_Yearly_Summary_Labeled.csv')
    ...
    export_file = os.path.join(output_dir, 'Winter_Station_Summary_Labeled.csv')
...
if __name__ == "__main__":
    ...
    if df is not None and len(df) > 0:
        ...
        if len(df) > 0:
            ...
            print(f"     • Winter_Analysis_Dashboard_Final.png")
            print(f"     • Monthly_Breakdown_Final.png")
            print(f"\n Data Files (CSV):")
            print(f"     • Winter_Data_Full_Labeled.csv")
            print(f"     • Winter_Monthly_Summary_Labeled.csv")
            print(f"     • Winter_Yearly_Summary_Labeled.csv")
            print(f"     • Winter_Station_Summary_Labeled.csv")
            print(f"\n  Location: {OUTPUT_DIR}")
            print("="*80 + "\n")
